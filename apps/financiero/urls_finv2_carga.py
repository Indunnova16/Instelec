...
from .views_finv2_carga import CargaFinancieraView, DescargarVersionHomologacionXlsxView, ExportarTablaMaestraXlsxView, PlanoFinancieroCsvView
...
urlpatterns = [
    ...
    path('carga-financiera/homologacion/xlsx/', ExportarTablaMaestraXlsxView.as_view(), name='exportar_tabla_maestra_xlsx'),
]
