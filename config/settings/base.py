"""
Django base settings for TransMaint project.
"""
import os
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.core.context_processors.financiero_menu_context',
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='transmaint'),
...
WOMPI_REFERENCE_PREFIX = config('WOMPI_REFERENCE_PREFIX', default='INSTELEC')
